...
module Gitlab
  module DrepoImportExport
    class Importer
      ...
      def import_file
        Gitlab::DrepoImportExport::FileImporter.import(project: @project,
                                                       archive_file: @archive_file,
                                                       shared: @shared)
      end

      def check_version!
        Gitlab::DrepoImportExport::VersionChecker.check!(shared: @shared)
      end

      def project_tree
        @project_tree ||= Gitlab::DrepoImportExport::ProjectTreeRestorer.new(user: @current_user,
                                                                             shared: @shared,
                                                                             project: @project)
      end

      def avatar_restorer
        Gitlab::DrepoImportExport::AvatarRestorer.new(project: project_tree.restored_project, shared: @shared)
      end

      def repo_restorer
        Gitlab::DrepoImportExport::RepoRestorer.new(path_to_bundle: repo_path,
                                                    shared: @shared,
                                                    project: project_tree.restored_project)
      end

      def wiki_restorer
        Gitlab::DrepoImportExport::WikiRestorer.new(path_to_bundle: wiki_repo_path,
                                                    shared: @shared,
      ...
      def uploads_restorer
        Gitlab::DrepoImportExport::UploadsRestorer.new(project: project_tree.restored_project, shared: @shared)
      end

      def lfs_restorer
        Gitlab::DrepoImportExport::LfsRestorer.new(project: project_tree.restored_project, shared: @shared)
      end

      def statistics_restorer
        Gitlab::DrepoImportExport::StatisticsRestorer.new(project: project_tree.restored_project, shared: @shared)
      end
