...
import DrepoPreviewTabs from './drepo_preview_tabs';
import IssuablesHelper from '~/helpers/issuables_helper';
import { addDelimiter } from '~/lib/utils/text_utility';

function DrepoPreview(opts) {
  // Initialize DrepoPreview behavior
  //
  // Options:
...
// Local jQuery finder
DrepoPreview.prototype.$ = function(selector) {
  return this.$el.find(selector);
};

DrepoPreview.prototype.initTabs = function() {
  if (window.mrTabs) {
    window.mrTabs.unbindEvents();
  }

  window.mrTabs = new DrepoPreviewTabs(this.opts);
};

DrepoPreview.prototype.showAllCommits = function() {
  this.$('.first-commits').remove();
  return this.$('.all-commits').removeClass('hide');
};

DrepoPreview.prototype.initMRBtnListeners = function() {
  var _this;
  _this = this;
...
DrepoPreview.prototype.submitNoteForm = function(form, $button) {
  var noteText;
...
DrepoPreview.prototype.initCommitMessageListeners = function() {
...
DrepoPreview.setStatusBoxToMerged = function() {
...
DrepoPreview.decreaseCounter = function(by = 1) {
...
DrepoPreview.hideCloseButton = function() {
