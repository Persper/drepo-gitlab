...
describe 'Git LFS API and storage' do
    ...
    context 'with LFS disabled globally' do
      ...
      describe 'LFS disabled in project' do
        ...
        it 'responds with a 501 message on download' do
          get "#{project.http_url_to_repo}/gitlab-lfs/objects/#{sample_oid}", headers: headers
  ...
  describe 'deprecated API' do
    ...
    context 'when fetching lfs object using deprecated API' do
      ...
      before do
        get "#{project.http_url_to_repo}/info/lfs/objects/#{sample_oid}", headers: headers
      end
  ...
  describe 'when pushing a lfs object' do
    ...
    describe 'to a forked project' do
      ...
      describe 'and second project not related to fork or a source project' do
        ...
        context 'when pushing the same lfs object to the second project' do
          before do
            put "#{second_project.http_url_to_repo}/gitlab-lfs/objects/#{sample_oid}/#{sample_size}", headers: headers.merge('X-Gitlab-Lfs-Tmp' => lfs_tmp_file).compact
          end
    ...
    def put_authorize(verified: true)
      ...
      put "#{project.http_url_to_repo}/gitlab-lfs/objects/#{sample_oid}/#{sample_size}/authorize", headers: authorize_headers
    end
