  ...
  describe 'updating merge_commit' do
    ...
    it "updates merge requests' merge_commits" do
      expect(Gitlab::BranchPushMergeCommitAnalyzer).to receive(:new).and_wrap_original do |original_method, commits|
        expect(commits.map(&:id)).to eq(%w{db46a1c5a5e474aa169b6cdb7a522d891bc4c5f9 689600b91aabec706e657e38ea706ece1ee8268f 8a994512e8c8f0dfcf22bb16df6e876be7a61036 5f82584f0a907f3b30cfce5bb8df371454a90051 29284d9bcc350bcae005872d0be6edd016e2efb5 646ece5cfed840eca0a4feb21bcd6a81bb19bda3})
